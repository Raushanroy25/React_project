...
export class Services extends Component {
  render() {
    return (
      <div>
        <div className="container" class="ourservices">
          <Zoom Top>
                ...
                <Zoom Top>
                  ...
                  <Card.Body>
                    <Card.Title className="ctitle">
                      <b>Old Town Cafe`: From Bean to Cup</b>
                    </Card.Title>
                    <Card.Text className="ctext">
                      <i>
                        As our motto suggests, we make every cup of coffe from
                        scratch,everything from choosing the best coffee beans
                        ,creating and grinding our own blends to a beautiful
                        Aromatic cup of Coffee that is served to you with all
                        our Love. Our Beautiful Ambience adds perfectly to the
                        experience of our customers, whom we treat like Family.
                        We also offer a range of coffee products: Coffee Beans,
                        blends, Creamers etc., customers can buy products from
                        our cart system. We also offer the option of venue
                        booking for your special occasions.
                      </i>
                    </Card.Text>
