    ...
    return (
      <div id="body">
        <Carousel fade id="carousl">
          <Carousel.Item class="carosltext">
            ...
            <Carousel.Caption>
              ...
              <p className="p">
                {" "}
                Explore with us the world filled with the beautiful Aroma of
                Freshly Made Coffee, from Bean to Cup.
              </p>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <Fade Right>
                <h3 className="h3">
                  Coffee Beans, the most important aspect of a flavour packed
                  cup of coffee.
                </h3>
              </Fade>
              <p className="p">
                Explore and learn about the wide range of cofee beans...check
                out our cofee products in the Our Products tab.
              </p>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <p className="p">
                The best way to embellish a cup of coffee is through Latte
                Art.Check out the beautiful latte art by our professionals in
                Galleries tab.
              </p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <p className="p">
                Explore the wide range of coffee products available and buy the
                best one for yourself from your cart.
              </p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="container" style={{ position: "fixed" }}></div>
